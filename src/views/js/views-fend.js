...
var resizePizzas = function(size) {
  ...
  function changeSliderLabel(size) {
    console.log("First func changeSliderLabel called");
    switch(size) {
      case "1":
  ...
  function determineDx (elem, size) {
     console.log("Third func call determineDx");
    ...
    function sizeSwitcher (size) {
      console.log("Fourth func sizeSwitcher");
      switch(size) {
        case "1":
          return 0.25;
        case "2":
  ...
  function changePizzaSizes(size) {
    console.log("Second function called changePizzaSizes");
